...
- The current shared package version consumed by the Service project is `1.5.0`.
- `IPlayerLookupContract` (the lookup query signature) is defined locally in this repo (`ApexLegendsTracker.Service.Services`), not in the shared package.
